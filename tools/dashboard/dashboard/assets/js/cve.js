...
(function (root, factory) {
  ...
  function create(deps) {
    ...
    /* Зона отвечает за точность: свой containment walk на dragleave ниже
       ...
       узлов. Зона зажигает себя сама — это её подсветка, ничья больше.
       Документный слой ниже файл принимает, но page-wide подсветки не
       заводит: это осознанно не сделано, а не забыто. В files.js
       документный уровень зону подсвечивает — там оба экрана разошлись,
       и разница записана в TODO.md. */
