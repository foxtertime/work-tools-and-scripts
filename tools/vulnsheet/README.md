...
| `2` | фатально: неверные аргументы (в том числе нет ни `--blocks`, ни `--table`, или `--table -`); нет версии RHEL, хаба или тега ни во флагах, ни в конфиге; конфиг не найден, не читается или не проходит проверку; нет PyYAML при заданном конфиге; блоки не читаются, не в UTF-8 или пусты; таблица не читается или не в формате vulnsheet; выход не пишется; хаб koji недоступен, тега нет или не установлен `koji` |
